...
export function inyectarMovil() {
  ...
  .op-histbtn{margin-left:auto;display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;padding:0;border-radius:9px;color:var(--mv-gold);background:rgba(232,184,75,.1);border:1px solid rgba(232,184,75,.4);cursor:pointer;align-self:center}
  .op-histbtn svg{width:19px;height:19px}
  .op-histbtn:active{transform:scale(.94)}
